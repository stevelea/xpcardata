...
class _FleetStatsScreenState extends ConsumerState<FleetStatsScreen> {
  ...
  Widget _buildNoDataState() {
    final analyticsService = FleetAnalyticsService.instance;
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: analyticsService.isEnabled
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    analyticsService.isEnabled ? Icons.check_circle : Icons.info_outline,
                    color: analyticsService.isEnabled ? Colors.green : Colors.orange,
                    size: 20,
                  ),
                  const SizedBox(width: 8),
                  Text(
                    analyticsService.isEnabled
                        ? 'You are contributing to fleet data'
                        : 'Enable Fleet Analytics in Settings to contribute',
                    style: TextStyle(
                      color: analyticsService.isEnabled ? Colors.green[700] : Colors.orange[700],
                      fontSize: 12,
                    ),
                  ),
                ],
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildStatItem(
                  icon: Icons.insights,
                  value: '${_fleetStats?.totalContributions ?? 0}',
                  label: 'Contributions',
                  color: Colors.purple,
                ),
                _buildStatItem(
